    ...
    <?php if ($row['status'] == 2): ?>
        ...
        <div class="tiding" id="tiding-<?= $row['id']; ?>">
            <div class="tiding-img element_tiding_hide">
                <?php if ($row['img'] == null): ?>
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/lab2/images/general/NotLoadImage.png" alt="Image">
                <?php else: ?>
            ...
            <div class="tiding-show tiding-control-hide">
                ...
                <?php if ($_POST['url'] === "admin"): ?>
                    <div class="tiding_control">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/lab2/images/general/HideTiding.png" alt="Image" title="Скрыть новость" class="hide_tiding" onclick="hide_tiding(this)">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/lab2/images/general/DeleteTiding.png" alt="Image" title="Удалить новость" class="delete_tiding" onclick="delete_tiding(this)">
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="edit_tiding" id="edit_tiding-<?= $row['id']; ?>">
            <form action="" method="post" id="form_edit_tiding" class="form_edit_tiding" enctype="multipart/form-data" novalidate>
    ...
    <?php else: ?>
        ...
        <div class="tiding" id="tiding-<?= $row['id']; ?>">
            ...
            <div class="tiding-show">
                ...
                <?php if ($_POST['url'] === "admin"): ?>
                    <div class="tiding_control">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/lab2/images/general/ShowTiding.png" alt="Image" title="Скрыть новость" class="hide_tiding" onclick="hide_tiding(this)">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/lab2/images/general/DeleteTiding.png" alt="Image" title="Удалить новость" class="delete_tiding" onclick="delete_tiding(this)">
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="edit_tiding" id="edit_tiding-<?= $row['id']; ?>">
            <form action="" method="post" id="form_edit_tiding" class="form_edit_tiding" enctype="multipart/form-data">
                <div class="tiding_part">
                    <p>
                        <label for="edit_tiding_title">Заголовок: <i class="fa fa-asterisk" aria-hidden="true"></i></label>
                        <input type="text" name="edit_tiding_title" id="edit_tiding_title" value="<?= $row['title']; ?>" required>
                ...
                <div class="tiding_part old-img">
                    <label>Выбранное изображение:</label>
                    <?php if ($row['img'] == null): ?>
                        <span>Изображение не было загружено!</span>
                    <?php else: ?>
                        <img src="data:image/png;base64, <?= base64_encode($row['img']); ?>" alt="Image">
                    <?php endif; ?>
                </div>
