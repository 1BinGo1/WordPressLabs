    ...
    <div class="container">
        <div class="main">
            ...
            <div class="create_tiding create_tiding_hide">
                ...
                <form action="" method="post" id="form_create_tiding" class="form_create_tiding" enctype="multipart/form-data">
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/lab2/scripts/administration.js"></script>
</body>
</html>